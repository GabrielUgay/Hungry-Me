...
class MainActivity10 : AppCompatActivity() {
    ...
    private val itemPrices = listOf(148, 165, 48, 50, 50) // Prices of each item
    private val itemNames = listOf("Chicken with Rice", "Palabox with Iced tea", "Peach mango pie", "Sundae Twirl", "Coke Float")
    private val itemImages = listOf(R.drawable.chicken_with_rice, R.drawable.peach, R.drawable.chocolate_sundae_twirl, R.drawable.palabok_with_icetea, R.drawable.coke_float)
